...
import type { TaskListParams, TaskListData, Status, Priority } from "../types";
...
const TasksPage: React.FC = () => {
  ...
  // Debounce search — reset page to 1 on every search change
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-xs space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="flex gap-2">
            <select
              value={sortBy}
              onChange={(e) => handleSortByChange(e.target.value as "createdAt" | "updatedAt" | "dueDate")}
